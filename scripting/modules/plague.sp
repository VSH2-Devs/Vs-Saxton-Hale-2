...
methodmap CPlague < BaseBoss
{
	...
	public void Equip ()
	{
		...
		int SaxtonWeapon = this.SpawnWeapon("tf_weapon_bonesaw", 304, 100, 5, attribs);
	...
	public void RageAbility()
	{
		...
		{
			case 0: { attribute = 2; value = 2.0; }		// Extra damage for minions
	...
	public void KilledPlayer(const BaseBoss victim, Event event)
	{
		...
		if (this.userid equals victim.userid)
			return;
		victim.iOwnerBoss = this.userid;
		victim.ConvertToMinion(0.1);
	}
	public void Help()
	{
		if ( IsVoteInProgress() )
